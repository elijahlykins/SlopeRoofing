    ...
    <section id="testimonials" className="relative py-24 px-6 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4">What Our Clients Say</h2>
        ...
        <div className="relative">
          ...
          <div className="bg-white/40 backdrop-blur-2xl rounded-3xl p-12 border border-white/60 shadow-2xl">
            <div className="flex flex-col md:flex-row items-center gap-8">
              {/* Image */}
              <div className="flex-shrink-0">
                <div className="bg-white/60 backdrop-blur-xl rounded-2xl p-3 border border-white/80 shadow-lg">
              ...
              <div className="flex-1">
                <div className="flex items-center mb-4">
                  {[...Array(testimonials[currentIndex].rating)].map((_, i) => (
                    <i key={i} className="ri-star-fill text-2xl text-gray-900"></i>
                  ))}
                </div>
                ...
                <div className="bg-white/60 backdrop-blur-xl rounded-xl px-6 py-4 inline-block border border-white/80 shadow-md">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <button 
              ...
              className="w-12 h-12 flex items-center justify-center bg-white/40 backdrop-blur-xl hover:bg-white/60 rounded-full transition-all border border-white/60 shadow-lg hover:shadow-xl cursor-pointer"
            >
          ...
          <div className="flex justify-center mt-12">
            <button 
              ...
              className="bg-gray-900 hover:bg-black text-white px-10 py-4 rounded-full font-bold text-lg transition-all hover:shadow-2xl hover:-translate-y-1 flex items-center space-x-3 whitespace-nowrap cursor-pointer"
            >
